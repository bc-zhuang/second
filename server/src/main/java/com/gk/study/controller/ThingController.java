...
public class ThingController {
    ...
    public APIResponse listById(String keyword, String sort, String c, String tag, int userId){
        List<Thing> list =  service.getThingListById(keyword, sort, c, tag, userId);
