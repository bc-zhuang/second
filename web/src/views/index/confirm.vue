        ...
        <div class="cart-list-view">
          ...
          <div class="list">
            <div class="items flex-view">
              ...
              <a-input-number v-model:value="pageData.count" :min="1" @change="onCountChange" />
...
<script setup lang="ts">
  ...
  onMounted(() => {
    ...
    pageData.sellerId = route.query.userId;
    pageData.amount = pageData.price;
    repertory = route.query.repertory;
  ...
  const handleJiesuan = () => {
    ...
    formData.append('sellerId', pageData.sellerId);
    if (pageData.remark) {
    ...
    createApi(formData)
      .then((res) => {
        ...
        router.push({ name: 'pay', query: { amount: pageData.amount, userId: userId, thingId: pageData.id, count: pageData.count } });
      })
      .catch((err) => {
