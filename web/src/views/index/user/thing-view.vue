        ...
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="发布者id" name="repertory">
                  <a-input-number
                    v-if="modal.form.userId === undefined"
                    placeholder="请输入"
                    :min="0"
                    v-model:value="userStore.user_id"
                    style="width: 100%"
                    disabled
                  />
                  <a-input-number v-else placeholder="请输入" :min="0" v-model:value="modal.form.userId" style="width: 100%" disabled />
                </a-form-item>
              </a-col>
            </a-row>
          </a-form>
...
<script setup lang="ts">
  ...
  import { createApi, listApi, updateApi, deleteApi, listByIdApi } from '/@/api/thing';
